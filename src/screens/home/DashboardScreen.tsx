        ...
        <View style={styles.activityList}>
          {recentActivity.map((activity) => (
            <View key={activity.id} style={styles.activityItem}>
              <View style={[styles.activityIcon, { backgroundColor: activity.type === 'claim' ? '#4CAF5020' : activity.type === 'roi' ? '#FF980020' : '#2196F320' }]}>
                <Ionicons 
...
const styles = StyleSheet.create({
  ...
  actionTitle: { fontSize: 16, fontWeight: '600', color: '#1a1a1a', marginBottom: 4, textAlign: 'center' },
  actionSubtitle: { fontSize: 12, color: '#666', textAlign: 'center' },
  activityList: { backgroundColor: 'white', borderRadius: 12, overflow: 'hidden' },
  activityItem: { 
    flexDirection: 'row', 
    alignItems: 'center', 
    padding: 16, 
  ...
  activityTitle: { fontSize: 16, fontWeight: '600', color: '#1a1a1a', marginBottom: 2 },
  activityStatus: { fontSize: 14, color: '#666', marginBottom: 2 },
  activityTime: { fontSize: 12, color: '#999' },
  activityAmount: { fontSize: 16, fontWeight: '600', color: '#4CAF50' }
});
